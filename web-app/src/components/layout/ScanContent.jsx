  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex-1">
        <div className="flex flex-row gap-5 align-middle items-center mb-3">
          <button
            onClick={() => setCurrentView("codeEditor")}
            className={`max-w-32 items-center justify-center flex border-2 border-slate-800 shadow-lg duration-300 cursor-pointer active:scale-[0.98] rounded-xl p-2
                ${currentView === "codeEditor"
                ? "bg-slate-800 text-zinc-100"
                : "bg-transparent text-slate-800 hover:bg-slate-800 hover:text-zinc-100"
              }
  `}
          >
            Code Editor
          ...
          <button
            onClick={() => setCurrentView("scanResults")}
            className={`max-w-32 items-center justify-center flex border-2 border-slate-800 shadow-lg duration-300 cursor-pointer active:scale-[0.98] rounded-xl p-2
                ${currentView === "scanResults"
                ? "bg-slate-800 text-zinc-100"
                : "bg-transparent text-slate-800 hover:bg-slate-800 hover:text-zinc-100"}`}>
